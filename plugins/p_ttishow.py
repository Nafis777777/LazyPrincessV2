...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/Netflix_Dramas')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 caption=f'<b>ʜᴇʏ, {u.mention} 👋🏻\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ {message.chat.title}\n\nFind Any Media ! if you need any Movies Or Drama then enter the CineDrama name + years. 👍\n\nGuys Enter Only movie,drama Or Webseries Name like This 👇\nPushpa ✅\nPushpa 2021 ✅\nPushpa in Hindi ❌\nVincenzo ✅\nVincenzo S01 ✅\nVincenzo all season ❌</b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='http://t.me/CineDrama') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ DEV Channel ↭  🔥', url='http://t.me/Netflix_Dramas') ]
                                                                                    ] )
                )
